...
To add your modules just put a .py file in  <a href='https://github.com/JoHn-111/Userbot/tree/master/modules'>/plugins.</a>This file should have the following code:
```python3
